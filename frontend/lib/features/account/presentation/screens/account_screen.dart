...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Future<void> _saveChanges() async {
    ...
    if (newName.isEmpty) {
      showGlassToast(context, 'Name cannot be empty',
    ...
    try {
      ...
      showGlassToast(context, 'Profile updated successfully',
          type: GlassToastType.success);
    } on AuthException catch (e) {
      if (!mounted) return;
      setState(() => _saving = false);
      showGlassToast(context, AuthService.friendlyError(e),
          type: GlassToastType.error);
    }
  }
              ...
              children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Manage your profile',
                              style: TextStyle(
                                  fontSize: 14, color: cs.textSecondary)),
                        ],
                      ),
                    ),
                            ...
                            children: [
                              Text('About',
                                  style: TextStyle(
                                      ...
                                      fontWeight: FontWeight.w600,
                                      color: cs.textPrimary)),
                              Text('Learn about this application',
                                  style: TextStyle(
                                      fontSize: 14, color: cs.textSecondary)),
                            ],
                          ),
                ...
                Text('Delete Account',
                    style: TextStyle(
                        ...
                        color: cs.textPrimary)),
                const SizedBox(height: 6),
                Text('Permanently remove your CrackX account',
                ...
                const SizedBox(height: 24),
                Center(
                    child: Text('Mixed Feed Cracker v1.0.0',
                        style:
                            TextStyle(fontSize: 12, color: cs.textTertiary))),
  ...
  Future<void> _deleteAccount() async {
    ...
    try {
      await ScenarioService.deleteCurrentUserScenarios();
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'This will permanently delete your CrackX account. You will need to create a new account to use the app again.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                      fontSize: 13, color: cs.textSecondary, height: 1.5),
                ),
                const SizedBox(height: 24),
                Row(
                  children: [
          ...
          children: [
            ...
            Expanded(
              child: OutlinedButton(
                ...
                child: Text('Cancel',
                    style: TextStyle(
                        color: cs.textSecondary, fontWeight: FontWeight.w600)),
              ),
            ),
          ],
        ),
  ...
  Widget _editField(
      BuildContext cs, TextEditingController controller, String hint,
      {required bool readOnly}) {
    return TextField(
      controller: controller,
      readOnly: readOnly,
      style: TextStyle(
          fontSize: 14, color: readOnly ? cs.textTertiary : cs.textPrimary),
      decoration: InputDecoration(
        ...
        enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: BorderSide(color: cs.inputBorder)),
        focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide: BorderSide(
                color: readOnly ? cs.inputBorder : AppColors.cyan, width: 1.5)),
        contentPadding:
            const EdgeInsets.symmetric(horizontal: 14, vertical: 12),
        suffixIcon: readOnly
            ? Icon(Icons.lock_outline, size: 16, color: cs.textTertiary)
            : null,
      ),
    );
  }
